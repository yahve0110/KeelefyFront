  ...
  return (
    <div className="flex justify-center ">
      <div className="w-[600px] h-[620px] mt-28 relative">
        ...
        <Link href={"/lessons/A"}>
          <div
            className="absolute -bottom-[30px] right-[100px] w-20 h-20 flex items-center justify-center text-2xl font-bold bg-blue-500 rounded-full shadow-2xl cursor-pointer select-none
    ...
    [box-shadow:0_8px_0_0_#1b6ff8,0_13px_0_0_#1b70f841] border-[1px] border-blue-400"
        ...
        <Link href={"/lessons/A"}>
          <div
            className="absolute bottom-[55px] left-[80px] w-20 h-20 flex items-center justify-center text-2xl font-bold bg-blue-500 rounded-full shadow-2xl cursor-pointer select-none
    active:translate-y-2 active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] transition-all duration-150
    [box-shadow:0_8px_0_0_#1b6ff8,0_13px_0_0_#1b70f841] border-[1px] border-blue-400"
          >
            A2
        ...
        <Link href={"/lessons/A"}>
          <div
            className="absolute bottom-[210px] right-[80px] w-20 h-20 flex items-center justify-center text-2xl font-bold bg-blue-500 rounded-full shadow-2xl cursor-pointer select-none
    active:translate-y-2 active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] transition-all duration-150
    [box-shadow:0_8px_0_0_#1b6ff8,0_13px_0_0_#1b70f841] border-[1px] border-blue-400"
          >
            B1
        ...
        <Link href={"/lessons/A"}>
          <div
            className="absolute top-[175px] left-[80px] w-20 h-20 flex items-center justify-center text-2xl font-bold bg-blue-500 rounded-full shadow-2xl cursor-pointer select-none
    active:translate-y-2 active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] transition-all duration-150
    [box-shadow:0_8px_0_0_#1b6ff8,0_13px_0_0_#1b70f841] border-[1px] border-blue-400"
          >
            B2
        ...
        <Link href={"/lessons/A"}>
          <div
            className="absolute top-[25px] right-[80px] w-20 h-20 flex items-center justify-center text-2xl font-bold bg-blue-500 rounded-full shadow-2xl cursor-pointer select-none
    active:translate-y-2 active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] transition-all duration-150
    [box-shadow:0_8px_0_0_#1b6ff8,0_13px_0_0_#1b70f841] border-[1px] border-blue-400"
          >
            C1
        ...
        <Link href={"/lessons/A"}>
          <div
            className="absolute -top-[40px] left-[80px] w-20 h-20 flex items-center justify-center text-2xl font-bold bg-blue-500 rounded-full shadow-2xl cursor-pointer select-none
    active:translate-y-2 active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] transition-all duration-150
    [box-shadow:0_8px_0_0_#1b6ff8,0_13px_0_0_#1b70f841] border-[1px] border-blue-400"
          >
            C2
